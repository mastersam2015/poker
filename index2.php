...
$.get("player1r.php", { lastfetch : last_update },  function(data) {
zmienna=data;
});
...
$.ajax(
            {
                type: 'GET',
                url: 'player2.php?q1='+$('#zapis1').val()+'&q2='+$('#zapis2').val()+'&q3='+$('#zapis3').val()+'&q4='+$('#zapis4').val()+'&q5='+$('#zapis5').val(),
                dataType: 'json',
                success: function(jsonData)
                {
				//num = $.parseJSON(jsonData.d);
...
$.ajax(
			...
			window.location.href ='win2.php?q1='+nazwa1+'&q2='+nazwa2+'&bank='+$('#bank').val()+'&stul='+$('#stul').val()+'&stul2='+$('#stul2').val();
			//alert('www1');
			}
			if (parseInt(player1)<parseInt(player2)){
		
					window.location.href ='lose2.php?q1='+nazwa1+'&q2='+nazwa2+'&bank='+$('#bank').val()+'&stul='+$('#stul').val()+'&stul2='+$('#stul2').val();
			//alert('www2');
			}
